...
docker run -it -p 8500:8500 -m=10g --cpus=10 -v /root/tobe:/host simple-tensorflow-serving-cpu bash
...
docker run -it -p 8501:8501 -v /Users/tobe/code/simple_tensorflow_serving:/host simple-tensorflow-serving-cpu bash
...
docker run -it -m=10g --cpus=10 -p 8502:8502 -p 8503:8503 -v /root/tobe:/host tensorflow-serving-cpu  bash
